locals {
  ...
  service_principal_id = data.terraform_remote_state.auth.outputs.databricks_service_principal_id
  azure_client_id      = data.terraform_remote_state.auth.outputs.databricks_client_id
  azure_client_secret  = data.terraform_remote_state.auth.outputs.databricks_service_principal_password
